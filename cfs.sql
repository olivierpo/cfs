...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 21, 2018 at 08:39 PM
...
--
-- Table structure for table `tomorrow_reservations`
--

CREATE TABLE `tomorrow_reservations` (
  `RESERVATION_ID` int(10) NOT NULL,
  `START_TIME` datetime NOT NULL,
  `END_TIME` datetime NOT NULL,
  `DESCRIPTION` varchar(50) NOT NULL,
...
--
-- Dumping data for table `tomorrow_reservations`
--

INSERT INTO `tomorrow_reservations` (`RESERVATION_ID`, `START_TIME`, `END_TIME`, `DESCRIPTION`, `APPROVED`, `ROOM_ID`) VALUES
(1, '2018-06-18 12:00:00', '2018-06-18 13:00:00', 'Fortnite Tournament', 1, 16),
(2, '2018-06-18 15:00:00', '2018-06-18 22:00:00', 'Badmington Club meeting', 1, 20),
(3, '2018-06-18 00:00:00', '2018-06-19 00:00:00', 'Nothing lol', 0, 13),
(4, '2018-06-18 20:00:00', '2018-06-18 22:00:00', 'Laser Tag', 1, 13),
(5, '2018-06-18 17:00:00', '2018-06-18 19:00:00', 'Paintball fight', 1, 19);
...
--
-- Indexes for table `tomorrow_reservations`
--
ALTER TABLE `tomorrow_reservations`
  ADD PRIMARY KEY (`RESERVATION_ID`),
  ADD KEY `ROOM_ID` (`ROOM_ID`),
  ADD KEY `ROOM_ID_2` (`ROOM_ID`);
